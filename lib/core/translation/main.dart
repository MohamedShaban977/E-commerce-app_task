...
class LocalizeAndTranslate {
  ...
  static final LocalizeAndTranslate _appTranslator =
      LocalizeAndTranslate._internal();
  ...
  /// reloads the app
  ///---
  dynamic applyChanges(BuildContext context) =>
      LocalizedApp.applyChanges(context);
  ...
  Iterable<Locale> locals() =>
      _langList.map<Locale>((String lang) => Locale(lang, ''));
}
