...
abstract class ProductDetailsDataSource {
  Future<CollectionResponse<ProductDetailsResponse>> getProductDetails(String id);
}
...
class ProductDetailsDataSourceImpl implements ProductDetailsDataSource {
  ...
  @override
  Future<CollectionResponse<ProductDetailsResponse>> getProductDetails(String id) async {
