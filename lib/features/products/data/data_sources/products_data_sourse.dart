...
abstract class ProductsDataSource {
  ...
  Future<CollectionResponse<ProductsResponse>> getProductsByCategory(String idCategory);
...
class ProductsDataSourceImpl implements ProductsDataSource {
 ...
 final  String _mostPopular ='1';
  ...
  Future<CollectionResponse<ProductsResponse>> getAllProducts() async {
    ...
    final res = CollectionResponse<ProductsResponse>.fromJson(
        response,
  ...
  @override
  Future<CollectionResponse<ProductsResponse>> getProductsByCategory(String idCategory) async {
    final response = await apiConsumer.get('${EndPoint.productsByCategoryById}$idCategory/');
  ...
  Future<CollectionResponse<ProductsResponse>> getMostPopularProducts() async {
    final response = await apiConsumer.get('${EndPoint.productsByCategoryById}$_mostPopular/');
  ...
  Future<CollectionResponse<ProductsResponse>> getMostRecentProducts() async {
    final response = await apiConsumer.get('${EndPoint.productsByCategoryById}$_mostRecent/');
